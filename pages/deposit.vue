    ...
    <div class="transactionPage">
        ...
        <div class="tileBlock" v-if="tokenSelectionOpened===false">
            ...
            <div v-else-if="loading===false">        
                ...
                <div class="errorText _text-center _margin-top-1" v-if="choosedToken && choosedToken.unlocked===true && inputTotalSum>transactionMaxAmount">
                    Not enough {{choosedToken.symbol}} to perform a transaction
                </div>
                <div class="tokenLocked" v-if="choosedToken && choosedToken.unlocked===false">
                ...
                <i-button block size="lg" variant="secondary" class="_margin-top-1" @click="deposit()" :disabled="!inputTotalSum || inputTotalSum>transactionMaxAmount" v-else>Deposit</i-button>
            </div>
            <div class="nothingFound _margin-top-1 _padding-bottom-1" v-else>
                <p class="_display-block _text-center" v-if="tip">{{tip}}</p>
        ...
        <div class="tileBlock tokensTile" v-else>
            ...
            <template v-else>
                ...
                <div class="tokenListContainer">
                    ...
                    <div class="nothingFound" v-if="search && displayedTokenList.length===0">
        ...
        deposit: async function() {
            ...
            try {
                ...
                const depositResponse = await wallet.depositToSyncFromEthereum({
                    ...
                    amount: ethers.BigNumber.from((await zksync.closestPackableTransactionAmount(wallet.provider.tokenSet.parseToken(this.choosedToken.symbol, this.inputTotalSum.toString()))).toString()),
                    ethTxOptions: {
                        gasLimit: "200000"
                    }
                });
