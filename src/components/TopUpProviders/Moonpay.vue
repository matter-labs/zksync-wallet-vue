...
export default Vue.extend({
  ...
  methods: {
    async proceed() {
      if (!this.isSupported) {
        this.$emit("providerError", `Provider Moonpay is not supported for the “${this.network}” network`);
        return;
      ...
      try {
        ...
        )}&defaultCurrencyCode=${availableZksyncCurrencies[0]}&showOnlyCurrencies=${encodeURIComponent(
