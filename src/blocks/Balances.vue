  ...
  <div>
    <i-modal v-model="balanceInfoModal" size="md">
      ...
      <div>
        ...
        <p>
          Your zkSync balances live in a separate space called Layer-2 (L2 for short).
          You won’t see them on <a href="//etherscan.io" target="_blank" rel="noopener noreferrer">etherscan.io</a> or in your
          Ethereum wallet, only in zkSync wallet and block explorer.
