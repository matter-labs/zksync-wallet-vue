<template>
  <i-modal v-model="opened" size="md">
    ...
    <p>
      <strong>RIF Rollup Alternative Withdrawal</strong> is way to get funds to Layer 1 without interacting directly with
      the protocol. RIF Rollup supports most of web3-compatible wallets, so we highly recommend you to use the so the
    ...
    <div class="_margin-top-1">
      ...
      <ul>
        <li>It must exist (hold any funds) in the Rollup network for at least 24 hours.</li>
