<template>
  <i-modal :value="opened" class="prevent-close" size="md" data-cy="account_activation_modal" @hide="close()" data-cy="account_activation_modal">
    ...
    <div class="_text-center">
      ...
      <i-button :disabled="loading" class="_margin-top-2" block size="lg" variant="secondary" data-cy="account_activation_sign_button" @click="signActivation()" data-cy="account_activation_sign_button">
