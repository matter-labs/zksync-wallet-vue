<template>
  <i-modal :value="opened" class="prevent-close" size="md" @hide="close()" data-cy="account_activation_modal">
    ...
    <div class="_text-center">
      ...
      <i-button :disabled="loading" class="_margin-top-2" block size="lg" variant="secondary" @click="signActivation()" data-cy="account_activation_sign_button">
