...
export const ETHER_NETWORK_CAPITALIZED: string = `${ETHER_NETWORK_NAME.charAt(0).toUpperCase()}${ETHER_NETWORK_NAME?.slice(1)}`;
export const CURRENT_APP_NAME: string = `${name}@${ETHER_NETWORK_CAPITALIZED}`;
