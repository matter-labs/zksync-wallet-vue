    ...
    <div class="providers-page-tile tileBlock">
      ...
      <section class="tileSubContainer">
        ...
        <div class="secondaryText small _margin-bottom-05">
          You can buy crypto directly on RIF Rollup with your credit card, just go through KYC process of our partners
      ...
      <section class="tileSubContainer">
        ...
        <div class="secondaryText small _margin-bottom-05">
          RIF Rollup is integrated with exchanges, so you can deposit/withdraw funds from your favorite exchanges
          directly inside the RIF Rollup network using the benefits of the low fees
        </div>
